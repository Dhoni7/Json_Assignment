...
rd.on('close', function() {
  ...
  fs.writeFile('../outputdata/s1.json', JSON.stringify(arr1));
  fs.writeFile('../outputdata/s2.json', JSON.stringify(arr2));
  fs.writeFile('../outputdata/s3.json', JSON.stringify(arr3));
    console.log('Done');
});
